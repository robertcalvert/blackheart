 ...
 * @author rob
 */
public final class WallRed extends IWall {
    
     public WallRed(Level level, Vector3f _position) {
        super(level, _position);
        texture_front = new TextureUV(_level._game._core._texture.game_atlas, 80, 46, 16, 16);
