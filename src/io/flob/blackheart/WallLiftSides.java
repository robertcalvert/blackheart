 ...
 * @author rob
 */
public final class WallLiftSides extends IWall {
    
     public WallLiftSides(Level level, Vector3f _position) {
        super(level, _position);
        texture_front = new TextureUV(_level._game._core._texture.game_atlas, 112, 62, 16, 16);
