 ...
 * @author rob
 */
public final class WallBlue extends IWall {
    
     public WallBlue(Level level, Vector3f _position) {
        super(level, _position);
        texture_front = new TextureUV(_level._game._core._texture.game_atlas, 0, 14, 16, 16);
