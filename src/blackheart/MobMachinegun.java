...
public final class MobMachinegun extends IMob {
    ...
    private final int animation_speed_shooting_delay = 75;
    ...
    public MobMachinegun(Level level, Vector3f _position) {
        ...
        // Standing
        texture[0] = new TextureUV(_level._game._core._texture.game_atlas, 0, 123, 12, 14);
        // Walking
        texture[1] = new TextureUV(_level._game._core._texture.game_atlas, 12, 123, 12, 14);
        texture[2] = new TextureUV(_level._game._core._texture.game_atlas, 24, 123, 12, 14);
        // Shooting
        texture[3] = new TextureUV(_level._game._core._texture.game_atlas, 36, 123, 12, 14);
        texture[4] = new TextureUV(_level._game._core._texture.game_atlas, 48, 123, 12, 14);
        // Dying
        texture[5] = new TextureUV(_level._game._core._texture.game_atlas, 60, 123, 12, 14);
        texture[6] = new TextureUV(_level._game._core._texture.game_atlas, 72, 123, 12, 14);
        texture[7] = new TextureUV(_level._game._core._texture.game_atlas, 84, 123, 12, 14);
        texture[8] = new TextureUV(_level._game._core._texture.game_atlas, 96, 123, 12, 14);
    }
            ...
            if (attacking & ray_picker().object().equals(_level._barry)) {
                if (Misc.time() >= animation_timer) {
                    if (!shooting) {
                        ...
                        _level._game._core._sound.weapon_machinegun.playAsSoundEffect(1.0f, 1.0f, false,
